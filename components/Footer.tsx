...
const links = [
	{
		...
		icon: (props: IconProps) => (
			<svg fill='currentColor' width='20' height='20' {...props}>
				<path
					fillRule='evenodd'
	...
	},
	{
		...
		href: '#',
		icon: (props: IconProps) => (
			<svg fill='currentColor' width='21' height='20' {...props}>
				<path
					fillRule='evenodd'
	...
	},
	{
		...
		href: '#',
		icon: (props: IconProps) => (
			<svg fill='currentColor' width='21' height='18' {...props}>
...
const Footer = () => {
	return (
		<footer className='flex flex-col items-center gap-8 bg-darkBlue p-10 text-white md:flex-row md:justify-between md:px-40 md:py-12'>
				...
				<div className='flex items-center gap-4'>
					{links.map((link) => (
						<a key={link.name} href={link.href}>
							...
							<link.icon
								className='fill-white hover:fill-limeGreen'
								aria-hidden='true'
								focusable='false'
							/>
						</a>
			...
			<ul className='grid grid-cols-1 justify-items-center gap-2 md:grid-cols-2 md:justify-items-start'>
